...
const CampSite=({backgroundImage,title,subtitle,peoplejoined}:
  ...
  return (
    <div className={`h-full w-full min-w-[1100px] ${backgroundImage}
      bg-cover bg-center bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl
    `}>
  ...
  return (
    ...
    lg:py-20 xl:mb-20'>
      ...
      <CampSite
        ...
        peoplejoined="1.4k Joined"
        />
      <CampSite
       backgroundImage="bg-bg-img-2"
       title="Mountain View"
       subtitle="SomeWhere in Wild"
       peoplejoined="1.9k Joined"
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        ...
        rounded-3xl">
          ...
          capitalize text-white">
            ...
            <p className="regular-14 xl:regualar-16 mt-5 text-white">
              Starting from the anxiert of the climbers when visitinf a new climbing location , the possibility if getting lost is very large That's why we are here for those of you who want to start an adventure 
            </p>
            <Image
            src="/quote.svg"
            alt="camp-2"
